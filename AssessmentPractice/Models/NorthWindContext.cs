...
namespace EF_Assessment.Models;
...
public partial class NorthWindContext : DbContext
{
    ...
    // DTO for sp
    public virtual DbSet<SP_CustOrderHist> SP_CustOrderHists { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //Dto sp
        modelBuilder.Entity<SP_CustOrderHist>().HasNoKey().ToView(null);
